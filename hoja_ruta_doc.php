		 ...
		 <td  colspan="2">
			 <table width="800" border="0" cellpadding="1">
			  <tr>
				...
				SOFTWARE DE CORRESPONDENCIA MINISTERIAL MSyD-'.utf8_encode ($gest).'</td>
				<td width="20%">&nbsp;</td>
			  </tr>
			  <tr>
...
$mpdf->SetFooter('| Copyright - 2013 Ministerio de Salud y Deportes. Todos los Derechos Reservados |');
$mpdf->WriteHTML($html);
$mpdf->Output();
exit;
?>
