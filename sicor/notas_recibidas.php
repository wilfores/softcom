...
<?php
	...
	$ssql="SELECT * FROM registroarchivo a, derivaciones b
	   ...
	   AND b.derivaciones_proveido='N'
	   AND (a.registroarchivo_estado='T' OR a.registroarchivo_estado='D' OR a.registroarchivo_estado='O')
           ORDER BY registroarchivo_fecha_pdf DESC";

$respi=mysql_query($ssql,$conn);		   
?>
<br>
<p class="fuente_titulo"><span class="fuente_normal">
<center><b>ARCHIVOS  RECIBIDOS</b></center></p>
...
<td width="10%" align="center"><span class="fuente_normal">Documento</span></td>
...
<td align="center" width="10%"><?php echo $row["registroarchivo_fecha_pdf"];?></td>
...
<td align="justify" width="30%"><?php echo $row["registroarchivo_referencia"];?></td>

	<td width="10%" align="center">
		<a href="historia_nota.php?valor=<?php echo $id_encriptado;?>"><img src="images/documentos.png" border="0">
        </a>
    </td>

<td width="15%" align="center">
<?php
if($row["registroarchivo_estado"] == 'D')
{
?>
    <a href="nota_recibir.php?valor=<?php echo $id_encriptado;?>" class="botonte" >Aprobar</a>&nbsp;&nbsp;
    <a href="nota_recibir_observar.php?valor=<?php echo $id_encriptado;?>" class="botonte" >Enviar</a>
<?php
}
else
{
