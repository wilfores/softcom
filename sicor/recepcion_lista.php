...
<br>
<p class="fuente_titulo"><center><b>RECEPCI&Oacute;N DE CORRESPONDENCIA POR DEPARTAMENTO</b></center></p></center>

<table width="100%" cellspacing="1" cellpadding="1" border="0">
<tr class="border_tr2">
<td width="4%" align="center"><span class="fuente_normal">Prioridad</td>
<td width="10%" align="center"><span class="fuente_normal"><a href="recepcion_lista.php?orden=seguimiento_hoja_ruta" style="color:#FFFFFF">Hoja de Ruta</a></td>
<td width="3%" align="center"><span class="fuente_normal">Adj</td>
<td width="10%" align="center"><span class="fuente_normal"><a href="recepcion_lista.php?orden=seguimiento_fecha_deriva" style="color:#FFFFFF">Fecha Despacho</a></td>
...
<td width="10%" align="center"><span class="fuente_normal"><a href="recepcion_lista.php?orden=seguimiento_remitente" style="color:#FFFFFF">Remitente</a></td>
...
<td colspan="2" width="12%" align="center"><span class="fuente_normal">*</td>
</tr>
</table>
...
<td align=left width="10%" valign=middle>
    ...
    <a href="visualizar.php?datosv=<?php echo $datosv;?>" style="color:#184E93">
...
?>
<td align="center"><a href="derivar.php?datos=<?php echo $datos;?>" class="botonte">Derivar</a></td>
<td align="center"><a href="terminar.php?datos=<?php echo $datos;?>" class="botonte">Terminar</a></td>
<td align="center"><a href="ingreso_nota.php?datos=<?php echo $datos;?>" class="botonte">Responder</a></td>
<?php
 } else 
 {  
?>
<td align="center" colspan="2"><a href="recibido.php?datos=<?php echo $datos;?>" class="botonte">&nbsp;Recepcionar&nbsp;</a></td>
<?php
 } 
 ?>
</tr>
