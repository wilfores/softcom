...
<table  border="1" cellpadding="1" cellspacing="1" align="center">
	...
	<tr class="border_tr3">
		<form name="entidad" method="post" action="filtrado_de_comi.php">
		<td valign"middle">
...
<? //echo "$row[1]";?>
 ...
 <a href="guar_tem2.php?hr1=<?=$row[0];?>&val=<?=$row[1];?>&val1=<?=$row[3];?>&val2=<?=$row[4];?>&val3=<?=$row[5];?>" style="color:#0033FF; text-decoration:underline"><? echo "$row[1]";?></a>
