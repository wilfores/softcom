...
switch ($_POST['clase'])
{
	...
	case 'por_terminados': 
	 ...
	 case 'por_departamentop': 
							...
							$mititulo="DEPARTAMENTO CON CORRESPONDENCIA PENDIENTE";
	 break;
	 ...
	 case 'por_departamentot': 
							...
							$mititulo="DEPARTAMENTO CON CORRESPONDENCIA TERMINADA";
	 break;
	 ...
	 case 'por_eremitente': 
	  ...
	  break;
	   ...
	   case 'por_ingreso': 
							...
							AND a.seguimiento_dpto_remite='0'
							where   c.usuario_nombre LIKE '%$_POST[revisar]%'";
							 if ($var_sw==1)
								{ 
...
<table width="100%" cellspacing="1" cellpadding="1" border="2" style="font-size:9px">
<tr class="border_tr2">
...
{
  $ssql11="select * from ingreso where ingreso_nro_registro='$rowas[seguimiento_nro_registro]' AND '$cod_institucion'=ingreso_cod_institucion";
...
if($rowamas=mysql_fetch_array($respuestamas))
{
  ...
  ?>
    ...
    <td align="center" class="border_table_imp"><?php echo $rowas["seguimiento_hoja_ruta"]; ?></td>
    <td align="center" class="border_table_imp"><?php echo $tipito; ?></td>
    <td align="center" class="border_table_imp">
	<?php 
		if($rowamas["ingreso_hoja_ruta_tipo"]=='i')
    {
    ...
    if ($_POST['clase']=='por_destinatario_original')
		{
			$respuestatres=mysql_query("select a.departamento_descripcion_dep from departamento a, usuario b where b.usuario_nombre='$rowas[seguimiento_destinatario_principal]' AND b.usuario_cod_departamento=a.departamento_cod_departamento",$conn);
		}
		else
		{
