...
{
  $sql_ent2 = "SELECT * FROM registrodoc1 WHERE registrodoc1_estado='R' and registrodoc1_situacion='P' and registrodoc1_cc='NE' ORDER BY registrodoc1_fecha_recepcion DESC";
  
   /* $sql_ent2 = "SELECT * FROM registrodoc1 WHERE registrodoc1_estado='R' and registrodoc1_situacion='P' and registrodoc1_cc='NE' GROUP BY registrodoc1_cite ORDER BY registrodoc1_fecha_recepcion DESC";*/
  
 }
 else
 {
 $sql_ent2 = "SELECT * FROM registrodoc1 WHERE '$cod_dep'=registrodoc1_para and registrodoc1_estado='R' and registrodoc1_situacion='P' and registrodoc1_cc='NE' ORDER BY registrodoc1_fecha_recepcion DESC";
 /*
  $sql_ent2 = "SELECT * FROM registrodoc1 WHERE '$cod_dep'=registrodoc1_para and registrodoc1_estado='R' and registrodoc1_situacion='P' and registrodoc1_cc='NE' GROUP BY registrodoc1_cite ORDER BY registrodoc1_fecha_recepcion DESC";
 */
 }
...
function libro_usuario()
{
	...
	{
		document.lista.action="salida_imprimir.php";
...
if (!empty($rs_ent2)) 
{
 ...
 while ($row= mysql_fetch_array($rs_ent2))
	...
	<input name="lista_doc" type="checkbox" value="1" />
	</td>-->	
