...
/*
$rss2=mysql_query("SELECT registrodoc1_para, registrodoc1_para FROM registrodoc1 WHERE '$codigo'=registrodoc1_para and registrodoc1_estado='R' and registrodoc1_situacion='P' and registrodoc1_cc='E' ",$conn);
...
/*bandeja de salida*/
/*
$rss4=mysql_query("SELECT registrodoc1_de, registrodoc1_prioridad FROM registrodoc1 WHERE '$codigo'=registrodoc1_de and registrodoc1_estado='SR' and registrodoc1_cc='E'",$conn);
...
<table width="100%" border="0" cellpadding="1" align="center">
  ...
  <tr>
   <!--inicio de bandena de entrada-->
    <td height="400" bgcolor="#333333">	     
	     <!--
	   <div>
         <table width="450" bordder="0">
                    <tr>
                        <td style="font-size: 12px; color:#FFFFFF">
						<strong>BANDEJA DE ENTRADA</strong></td>
						<!---<input type="text" id="entrada" size="12" />
                        <a href="#" id="limp_ent" class="botonvent" style="background-color:#2A1F00;">Limpiar filtro</a>
					
						<td style="font-size: 12px; color:#FFFFFF" align="right"><b>Total de Archivos:&nbsp;&nbsp;<? echo "$s_t_r_d";?></b>
						</td>						
					</tr>
          </table>
        </div>
     
        <iframe  height="230" width="100%" frameborder="1" name="mainFrame" scrolling="si" src="ban_entrada.php" class="barrades" style="overflow-x:hidden;">
        </iframe> 		        
		-->
           
        <iframe  height="480" width="100%" frameborder="0" name="mainFrame" scrolling="si" src="comunicado.php" class="barrades" style="overflow-x:hidden;" align="center">
        </iframe>
   </td>
    </tr>
   <!--fin de bandena de entrada-->
  <tr>
    <td align="center">
		<table border="0">
		  <tr>
			...
			{
			?>
			<td><a href="listado_trabajos_pend.php">
			<img src="images/archivado.png" onmouseover="this.src='images/archivado1.png'" onmouseout="this.src='images/archivado.png'"></a></td>
			<?php
			}
			?>
			...
			<font color="#990000">...</font></a></td>
			<td><a href="libroenviados.php">            
			<font color="#990000">eeeeeeeee</font></a></td>
			<td><a href="librorecibidos.php">            
			<font color="#990000">rrrrrrrrr</font></a></td>
			<td><a href="librocites.php">            
			<font color="#990000">ccccccccc</font></a></td>
			<td><a href="librorecibidos.php">            
			<font color=#000099>ENLACE 1</font></a></td>
			<td><a href="../../../../Archivos de programa/Microsoft Office/Office12/OUTLOOK.EXE">            
			<font color="#990000">ENLACE 2</font></a></td>
