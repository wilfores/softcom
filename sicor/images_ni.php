...
$sect = &$rtf->addSection();
$sect->writeText("<b>NOTA INTERNA</b>", new Font(12, 'tahoma', '#000000'), new ParFormat('center'));
...
//referencia y fecha
$bus= mysql_query("SELECT * FROM registroarchivo where registroarchivo_hoja_interna='$valor_enviado' AND registroarchivo_tipo='NOTA INTERNA'" ,$conn);
...
$sect->writeText("De mi consideracion:", new Font(11, 'tahoma', '#000000'), new ParFormat());
$sect->writeText("<BR/>", new Font(), new ParFormat());
$sect->writeText("<BR/>", new Font(), new ParFormat());
$sect->writeText("<BR/>", new Font(), new ParFormat());
$sect->writeText("<BR/>", new Font(), new ParFormat());
