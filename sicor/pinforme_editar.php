...
{
  $radio_opcion=$_POST['tipo1'];
  $Tipo=$_POST['tipo_oculto'];
  $cite=$_POST['numero_cite'];

  //Caso Con Membrete
  if($radio_opcion='S')
  {
		//Caso CARTA
		if ($Tipo='NOTA EXTERNA')
		{
		   print "<meta http-equiv=Refresh content=\"0.00000001 ; url=impresion_cm_ne.php?valor_enviado=50&cite='$cite'\">"; 
        }			
		//Caso NOTA INTERNA
		if ($Tipo='NOTA INTERNA')
		{
		   print "<meta http-equiv=Refresh content=\"0.00000001 ; url=impresion_cm_ni.php?valor_enviado=27\">"; 
...
$cite=$fila_archivo["registroarchivo_hoja_interna"];
