...
<table width="100%" border="0" cellpadding="1" align="center">
  ...
  <tr>
   <!--inicio de bandena de entrada-->
    <td width="50%" height="230" bgcolor="#333333">	     
	   <div>
         <table width="500" bordder="0">
                    <tr>
        ...
        <iframe  height="230" width="100%" frameborder="1" name="mainFrame" scrolling="si" src="bandejaentrada.php" class="barrades" style="overflow-x:hidden;">
        </iframe>
   </td>
   <!--fin de bandena de entrada-->
   
   <!--inicio de bandena de salida-->
    <td width="50%" height="100%" bgcolor="#333333" rowspan="2">	 
	   <div>
        ...
        <iframe width="100%" height="480" frameborder="1" name="mainFrame" src="bandeja_salida.php" class="barrades">
        </iframe>	
...
<!------------------------------------------------------>  
  ...
  <tr>
   <!--inicio de correspondencia pendiente-->
    <td width="50%" height="220" bgcolor="#333333">
	 <div>
        ...
        <iframe  height="220" width="100%" frameborder="1" name="mainFrame" scrolling="si" src="bandejarecepcion.php"> </iframe>
       <!-- 
