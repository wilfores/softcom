...
<table width="90%" border="0">
	<tr bgcolor="#666666">
        ...
        <a href="recepcion_hoy.php" id="limp_ent" class="botonvent" style="background-color: black;" target="_self">Limpiar filtro</a>
		</td>
	</tr>
</table>
...
<img src="images/arch_adj.png" border="0" onMouseOver="this.src='images/arch_adj1.png'" onMouseOut="this.src='images/arch_adj.png'"></a>
		...
		?>
		<a href="terminar.php?hr1=<?php echo $doc_arch;?>" class="botonte" target="_top">Responder</a><br><br>
...
<img src="images/arch_adj.png" border="0" onMouseOver="this.src='images/arch_adj1.png'" onMouseOut="this.src='images/arch_adj.png'"></a>
		...
		<td colspan="5" align="center">
		<a href="derivar_doc.php?hr1=<?php echo $doc_arch;?>" class="botonte" target="_top" onMouseMove="window.status='Hola, no me ves';" onMouseOut="window.status='';">Derivar</a><br><br>
		<!-- <a href="terminar.php?hr1=<?php echo $doc_arch;?>" class="botonte" target="_top">Responder</a>-->
		<? 
