...
<center><b>LISTADO DE ARCHIVOS PENDIENTES</b></center></p></center>
...
<?php
$slista=" SELECT * FROM derivardoc WHERE '$codigo'=derivardoc_para and derivardoc_situacion='R' and derivardoc_estado='TP' and derivardoc_realizado='H'";
...
if (!empty($rslista)) 
{
 ...
 {
 //****
 $hoja_ruta = $rwlista["derivardoc_hoja_ruta"];
...
<td align="center"><?php echo $rwlista['derivardoc_proveido']; ?>
</td>

<td align="center" ><a href="volver_pendientes.php?hr1=<? echo $hr1;?>" class="botonte" target="_top">Volver a Pendientes</a>
</td>
