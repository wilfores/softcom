...
$ssql="select * from registroarchivo a,terminados c
	   where a.registroarchivo_codigo=c.terminados_hoja_interna 
	   AND c.terminados_cod_usr='$codigo_usuario'";
$respi=mysql_query($ssql,$conn);
?>
<br>
<p class="fuente_titulo"><span class="fuente_normal">
<center><b>ARCHIVO TERMINADOS</b></center></p></center>
...
<td width="5%" align="center"><span class="fuente_normal">Archivo</span></td>
...
<a href="adjuntar_nota1.php?valor=<?php echo $row["registroarchivo_codigo"];?>"><img src="images/documentos.png" border="0">
</a>
</td>
