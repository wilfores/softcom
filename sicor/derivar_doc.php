	...
	/*	if($_POST["tienecopias"]){
		...
		if ($totalsel == 0){
			...
			if ($llaveregistro == 0){
			  ...
			  //$insertar="call insertar_der_1('$hruta',$id_doc,$codigo,$dest,'$fec_deri','0000-00-00 00:00:00','$fec_plazo','0000-00-00 00:00:00','$prior',17,'SR','P','NH','$prov','NO',$ges,$n_adj,'$descr_adj','$foto_nombre','$filaval[original]')";
			}
			else{
			...
			//$insertar="call insertar_der_2('$hruta',$id_doc,$codigo,$dest,'$fec_deri','0000-00-00 00:00:00','$fec_plazo','0000-00-00 00:00:00','$prior',17,'SR','P','NH','$prov','NO',$ges,$n_adj,'$descr_adj','$foto_nombre','0')";
		...
		//			$id_doc=$rdoc[0]*1000+1;/*obtiene el maximmo del id del documento 2*/
		  ...
		  //$insertacopia="call insertar_der_3('$hruta$ncopia',$id_doc,$codigo,$destinatario,'$fec_deri','0000-00-00 00:00:00','$fec_plazo','0000-00-00 00:00:00','$prior',17,'SR','P','NH','$prov','NO',$ges,$n_adj,'$descr_adj','$foto_nombre','$hruta')";
