...
//echo "$valeli";
$res1=mysql_query("delete from temp2 where temp2_cod_mio='$codigo' and temp2_cod_para='$valeli'",$conn);
mysql_fetch_array($res1);
}
?>

<meta content="5;URL=listado_esc_comision.php" http-equiv="REFRESH"> 
<?php
