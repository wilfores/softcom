...
<script src="URL_DD_roundies.js"></script>A partir de ahí, podemos usarlo de dos maneras, limitándolo a IE o aplicándolo a todos los navegadores. La sintaxis genérica es esta:
...
<script>  DD_roundies.addRule('.ejemplo1', '15px');  DD_roundies.addRule('.ejemplo2', '30px 0 20px 0');  DD_roundies.addRule('.ejemplo3', '20px', true);</script>Así que bastaría colocar esas clases en un elemento HTML para que funcionara:
...
.ejemplo1 {  -moz-border-radius:15px;  -webkit-border-radius:15px;  -khtml-border-radius:15px;}
In facilisis enim sit amet lacus congue tristique. Aenean luctus mollis enim, non tincidunt tellus sodales nec. Aenean massa nisl; egestas ut bibendum luctus, iaculis vitae orci. In quis erat mi, quis luctus eros. Nam facilisis mauris at tellus bibendum semper. Vestibulum accumsan, sapien ullamcorper suscipit convallis, sapien magna venenatis enim, ut congue nunc orci ut erat.
