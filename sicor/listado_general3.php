...
<center><b style=" font-size:18px">BUSQUEDA DE CORRESPONDENCIA EXTERNA</b></center></p></center>
...
?>
		...
		<select name="campo_td" style="font-size:9px">
		  ...
		  <?php
			$respss=mysql_query("select clasecorrespondencia_descripcion_clase_corresp, clasecorrespondencia_codigo_clase_corresp 
									from clasecorrespondencia  
									order by clasecorrespondencia_descripcion_clase_corresp",$conn);
			while($rowass=mysql_fetch_array($respss))
			{
				if($_POST['campo_td']==$rowass["clasecorrespondencia_descripcion_clase_corresp"])
				{
				?>
		  <option value="<?=$rowass['clasecorrespondencia_descripcion_clase_corresp'];?>" selected><?php echo $rowass["clasecorrespondencia_descripcion_clase_corresp"];?></option>
		  <?php 
				}
				else
				{
					?>
		  <option value="<?=$rowass['clasecorrespondencia_descripcion_clase_corresp'];?>"><?php echo $rowass["clasecorrespondencia_descripcion_clase_corresp"];?></option>
		  <?php
				}//fin de else
...
$inicio=($pagina-1)*$t;
  	...
  	if(isset($_POST['fecha_ela1']))
	{
		...
		$slista="SELECT 
	registrodoc1_hoja_ruta, registrodoc1_cite, registrodoc1_fecha_elaboracion, registrodoc1_fecha_recepcion, usuarioexterno_nombre, registrodoc1_referencia, clasecorrespondencia_descripcion_clase_corresp as descripcion, registrodoc1_estado, registrodoc1_asociar, registrodoc1_asociar_h_r, registrodoc1_cc, registrodoc1_cite, usuarioexterno_cargo
	...
	registrodoc1_hoja_ruta, registrodoc1_cite, registrodoc1_fecha_elaboracion, registrodoc1_fecha_recepcion, usuarioexterno_nombre, registrodoc1_referencia, clasecorrespondencia_descripcion_clase_corresp as descripcion, registrodoc1_estado, registrodoc1_asociar, registrodoc1_asociar_h_r, registrodoc1_cc, registrodoc1_cite, usuarioexterno_cargo
	FROM `registrodoc1`, `clasecorrespondencia`, `usuarioexterno` 
	where usuarioexterno_nombre LIKE '%$_POST[campo_des]%'
    and registrodoc1_de=usuarioexterno_codigo
	and registrodoc1_doc=clasecorrespondencia_codigo_clase_corresp
	...
	registrodoc1_hoja_ruta, registrodoc1_cite, registrodoc1_fecha_elaboracion, registrodoc1_fecha_recepcion, usuarioexterno_nombre, registrodoc1_referencia, clasecorrespondencia_descripcion_clase_corresp as descripcion, registrodoc1_estado, registrodoc1_asociar, registrodoc1_asociar_h_r, registrodoc1_cc, registrodoc1_cite, usuarioexterno_cargo
	FROM `registrodoc1`, `clasecorrespondencia`, `usuarioexterno` 
	where usuarioexterno_nombre LIKE '%$_POST[campo_re]%'
    and registrodoc1_de=usuarioexterno_codigo
	and registrodoc1_doc=clasecorrespondencia_codigo_clase_corresp
	ORDER BY registrodoc1_n_h_r ASC";
	}
	...
	{
		//echo "$_POST[campo_un]";
		echo "<b><center>LA BUSQUEDA POR UNIDAD NO SE ENCUENTRA DISPONIBLE </center></b>";
	}
	...
	registrodoc1_hoja_ruta, registrodoc1_cite, registrodoc1_fecha_elaboracion, registrodoc1_fecha_recepcion, usuarioexterno_nombre, registrodoc1_referencia, clasecorrespondencia_descripcion_clase_corresp as descripcion, registrodoc1_estado, registrodoc1_asociar, registrodoc1_asociar_h_r, registrodoc1_cc, registrodoc1_cite, usuarioexterno_cargo
	FROM `registrodoc1`, `clasecorrespondencia`, `usuarioexterno` 
	where clasecorrespondencia_descripcion_clase_corresp LIKE '%$_POST[campo_td]%'
    and registrodoc1_de=usuarioexterno_codigo
	and registrodoc1_doc=clasecorrespondencia_codigo_clase_corresp
	GROUP BY registrodoc1_cite ORDER BY registrodoc1_n_h_r ASC";
	}
...
$total_paginas = ceil(mysql_num_rows($rslista) / $t);
		...
		<td align="left"><?php echo $rwlista[usuarioexterno_nombre];?>
		</td>
		
		<td align="left"><?php echo $rwlista[registrodoc1_referencia]; ?>
		</td>
		
		<td align="left"><?php echo $rwlista[descripcion];?></td>
		...
		<td align="center">
		<a href="seguimiento_doc.php?hr1=<?php echo $doc_arch;?>&ext=1" onMouseOver="window.status='Guia de sitio';return true" onMouseOut="window.status='';return true">
...
/*
	$slista="SELECT 
	registrodoc1_hoja_ruta, 
    registrodoc1_cite, 
    registrodoc1_fecha_elaboracion, 
    registrodoc1_fecha_recepcion, 
    usuarioexterno_nombre, 
    registrodoc1_referencia, 
    clasecorrespondencia_descripcion_clase_corresp, 
    registrodoc1_estado, 
    registrodoc1_asociar, 
    registrodoc1_asociar_h_r, 
    registrodoc1_cc, 
    registrodoc1_cite, 
    usuarioexterno_cargo
	FROM `registrodoc1`, `clasecorrespondencia`, `usuarioexterno` 
	where registrodoc1_de=usuarioexterno_codigo
	and registrodoc1_doc=clasecorrespondencia_codigo_clase_corresp
	and registrodoc1_n_h_r<>'0'
	and registrodoc1_depto_para = '$depto'
	GROUP BY registrodoc1_cite ORDER BY registrodoc1_n_h_r ASC";
...
$total_paginas = ceil(mysql_num_rows($rslista) / $t);
		...
		<td align="left"><?php echo $rwlista[usuarioexterno_nombre];?>		</td>
		
		<td align="left"><?php echo $rwlista[registrodoc1_referencia]; ?>		</td>
		
		<td align="left"><?php echo $rwlista[clasecorrespondencia_descripcion_clase_corresp];?></td>
		...
		<td align="center"><a href="seguimiento_doc.php?hr1=<?php echo $doc_arch;?>&ext=1" onmouseover="window.status='Guia de sitio';return true" onmouseout="window.status='';return true"><img src="images/ver.png" onmouseover="this.src='images/ver1.png'" onmouseout="this.src='images/ver.png'" /></a></td>
		</tr>
		<?php
			$lim_superior++;
		  //}//FIN DE IF
