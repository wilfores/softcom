...
<center><b style=" font-size:18px">LISTADO DE AFILIADOS DADOS DE BAJA</b></center></p></center>
<form name="ingreso" action="afilibajas.php" method="POST">
<center>
...
<tr style="font-size: 8pt; color:#FFFFFF" bgcolor="#3E6BA3">
	<td width="7%" align="center"><span >CI</td>
...
<?php
$slista="SELECT 
afiliacionbaja_id, afiliacionbaja_n_afi, afiliacionbaja_pat, afiliacionbaja_mat, afiliacionbaja_nom
FROM `afiliacionbaja`
ORDER BY afiliacionbaja_id desc LIMIT 0, 2000";
...
if (!empty($rslista)) 
{
 ...
 while($rwlista=mysql_fetch_array($rslista))
 {
	...
	{
	 $doc_archb=cifrar($rwlista["afiliacionbaja_id"]);
...
<td align="center"><?php echo $rwlista[afiliacionbaja_n_afi];?>
</td>

<td align="center"><?php echo $rwlista[afiliacionbaja_pat];?>
</td>

<td align="center"><?php echo $rwlista[afiliacionbaja_mat];?>
</td>

<td align="center"><?php echo $rwlista[afiliacionbaja_nom];?>
</td>
<td align="center">
<a href="impresion_afibaja.php?hr1=<?php echo  $doc_archb;?>" onMouseOver="window.status='Guia de sitio';return true" onMouseOut="window.status='';return true" target="_blank">
