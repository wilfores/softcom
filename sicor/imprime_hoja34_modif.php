...
{
    $hoja_rutax = $row["ingreso_hoja_ruta_interna"];
	$lugarcito = "La Paz";//$row["ingreso_lugar"];
	...
	$nrohoja = $row["ingreso_nro_registro"];
...
$cabeza1="<table border=\"1\" cellpadding=\"1\" cellspacing=\"1\" style=\"font-size:6px;\">
  <tr>
  <td width=\"104\" rowspan=\"2\"  align=\"center\"><img src=\"..\logos\ministerio.jpg\" border=\"0\" height=\"42\" width=\"55\" /></td>
   
   <td colspan=\"3\" rowspan=\"2\" align=\"center\" width=\"301\"><br/><style=\"font-size:7px;\">".utf8_encode($cabecera)."</style><br/><strong  style=\"font-size:11px;\">HOJA DE RUTA<br />".utf8_encode($nrohoja)."</strong></td>
    <td width=\"113\" rowspan=\"2\"  align=\"center\"><img src=\"".$loguito."\" border=\"0\" height=\"42\" width=\"55\" /></td> 
  </tr>
  <tr>
  ...
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">PROCEDENCIA</td>
    <td colspan=\"3\" width=\"301\">&nbsp;".utf8_encode($procedencia)."</td>
    <td colspan=\"2\" align=\"center\" bgcolor=\"#ededed\"  width=\"113\"  style=\"font-size:8px;\"><strong>TRÁMITE</strong></td>
  </tr>
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">LUGAR</td>
    <td width=\"301\">".utf8_encode($lugarcito)."</td>
	<td width=\"113\" align=\"center\">".utf8_encode($tramite)."</td>
  </tr>
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">REMITENTE</td>
    <td colspan=\"3\" width=\"301\">&nbsp;".utf8_encode($remitente)."</td>
    <td colspan=\"2\" align=\"center\" bgcolor=\"#ededed\"  width=\"113\"  style=\"font-size:8px;\"><strong>CITE</strong></td>
  </tr>
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">CARGO REMITENTE</td>
    <td colspan=\"3\" width=\"301\">&nbsp;".utf8_encode($cargo_remitente)."</td>
    <td colspan=\"2\"  width=\"113\" align=\"center\">".utf8_encode($cite)."</td>
  </tr>
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">ADJUNTOS</td>
    <td colspan=\"3\" width=\"301\">&nbsp;".utf8_encode($adjuntos)."</td>
    <td colspan=\"2\" rowspan=\"2\" align=\"center\" bgcolor=\"#ededed\"  width=\"113\"  style=\"font-size:8px;\"><strong>FECHA Y HORA DE REGISTROS</strong></td>
  </tr>
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">N&ordm; DE HOJAS </td>
    <td colspan=\"3\" width=\"301\">&nbsp;".$nodehojas."</td>
  </tr>
  <tr>
    <td align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">TIPO DE ADJUNTO</td>
    <td colspan=\"3\" width=\"301\">&nbsp;".utf8_encode($tipo_documento)."</td>
    <td colspan=\"2\" rowspan=\"1\" width=\"113\" align=\"center\">".$fecha2."</td>
  </tr>
  <tr>
    <td  align=\"left\" bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">REFERENCIA\n</td>
    <td  colspan=\"5\" width=\"414\">&nbsp;".utf8_encode($referencia)."</td>
  </tr>
  <tr>
  
    <td rowspan=\"2\" align=\"left\"  bgcolor=\"#ededed\" width=\"104\" style=\"font-size:7px;\">AREA DESTINO </td>
...
$subcabeza2="<font size=\"10\" align=\"center\" style=\"color: rgb(153, 153, 153);\">P R O V E I D O</font><BR /><br /><br /><br /><br /><br /><br /><br /><br /><font align=\"right\">---------------------------------------<BR />FIRMA Y SELLO           </font><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
$cabeza3="<table border=\"1\" cellpadding=\"1\" cellspacing=\"1\" style=\"font-size:7px;\">
  ...
  <tr>
    ...
    <td colspan=\"2\" rowspan=\"12\" valign=\"bottom\" width=\"379\">".$subcabeza3."</td>
  </tr>
  <tr>
    <td width=\"125\">Preparar Respuesta para mi firma </td>
    <td width=\"15\">&nbsp;</td>
...
$cabeza4="<table border=\"1\" cellpadding=\"1\" cellspacing=\"1\" style=\"font-size:7px;\">
  <tr>
    <td colspan=\"2\" align=\"center\" bgcolor=\"#ededed\" width=\"140\" style=\"font-size:7px;\"><strong>ACCI&Oacute;N</strong></td>
    <td width=\"50\" align=\"center\" bgcolor=\"#ededed\">Destinatario</td>
    <td colspan=\"4\" width=\"174\">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan=\"2\" rowspan=\"12\" valign=\"bottom\" width=\"379\">".$subcabeza4."</td>
  </tr>
  <tr>
    <td width=\"125\">Preparar Respuesta para mi firma </td>
    <td width=\"15\">&nbsp;</td>
