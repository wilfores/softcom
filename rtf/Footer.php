...
class Footer extends Container {
	...
	function getContent() {	
		...
		//$content .= '\\fs20\\i\\b 2012 Año de la No Violencia Contra La Niñez y La Adolescencia en el Estado Plurinacional de Bolivia \par';
		//$content .= 'Plaza del Estudiante - Telf. 2495053 - 2495086 Fax: 2492734 La paz - Bolivia \par ';
		//$content .= 'Plaza del Estudiante - Telf. 2495053 - 2495086 Fax: 2492734 La paz - Bolivia \par ';
		$content .= '}';
		return $content."\r\n";
	}		
