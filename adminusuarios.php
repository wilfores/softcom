...
{
	$ssql="SELECT * FROM usuario WHERE usuario_cod_nivel!='3' and usuario_cargo <> '' and usuario_cod_institucion='$_SESSION[institucion]'";
	if($_GET["cad"]=="unidad"){
		 $ssql=$ssql." order by usuario_cod_departamento";
	}
	else{
	 $ssql=$ssql." order by usuario_cod_usr";
	}
}
...
<TABLE width="90%" BORDER="0" CELLSPACING="2" CELLPADDING="0">
  <tr>
    ...
    <td width="5%" bgcolor="#eeeeee" onClick="window.location='adminusuarios.php'" id="micodigo" style="cursor:pointer;"><span class="fuente_normal"><b><center>C&Oacute;DIGO</center></b></td>
	<td width="15%" bgcolor="#eeeeee"><span class="fuente_normal"><B><CENTER>NOMBRE Y APELLIDO</CENTER></B></td> 
    <td width="8%" bgcolor="#eeeeee"><span class="fuente_normal"><B><CENTER>USUARIO</CENTER></B></td> 
    <td width="5%" bgcolor="#eeeeee"><span class="fuente_normal"><B><CENTER>CI</CENTER></B></td>     
    <td width="20%" bgcolor="#eeeeee"><span class="fuente_normal"><B><CENTER>CARGO</CENTER></B></td>
	<td width="15%" bgcolor="#eeeeee" onClick="window.location='adminusuarios.php?cad=unidad'" id="miunidad" style="cursor:pointer;"><span class="fuente_normal"><B><CENTER>UNIDAD</CENTER></B></td> 
...
?>
    ...
    <P class="parrafo_normal"><span class="fuente_normal">
	<strong><?php echo $row["usuario_username"];?></strong>
	</td>
